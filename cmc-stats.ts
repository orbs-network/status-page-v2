...
const OPERATIONAL_1 = "0xbf0BDC642090A9bAad286B58D41f89026B0F23b2" // considered nonCirculating according to CMC
const FOUNDERS_TRADING = "0x5e5A00903a8469291845Ac2Fb148e92c754B6Aa6" // considered nonCirculating according to CMC
const STAKING_REWARDS_1 = "0xB5303c22396333D9D27Dc45bDcC8E7Fc502b4B32" // considered nonCirculating according to CMC
const STAKING_REWARDS_2 = "0xdBb374E965B21C5d6EE370dcB80176884Fa936f1" // considered nonCirculating according to CMC
const PRIVATE_SALE_REMAINING= "0xd43424102fce7b967b3b1F0fc52152DA401E5510" // considered nonCirculating according to CMC
const ETH_LIQUIDITY = "0x2cf59F8986aa73D37F5Dc3A59a50DB2704f5aD9e" // considered nonCirculating according to CMC
const OPERATIONAL_2 = "0x64fefb4f855510c88b3d3b4b20c7f942ef928b4a" // considered nonCirculating according to CMC
const OPERATIONAL_3 = "0xE7670FDF36a49c2Cc358196af9bDC2bCfBABB0FD" // considered nonCirculating according to CMC
const MISTAKE_ADDRESS = "0xCAE24D45363Dcb03F19F44c5b6eD48E431fAFE63" // considered nonCirculating according to CMC


const NON_CIRCULATING_WALLETS = [LONG_TERM_RESERVES, PRIVATE_SALE, TEAM_AND_FOUNDING_PARTNERS, ADVISORS];
const NON_CIRCULATING_WALLETS_CMC = NON_CIRCULATING_WALLETS.push(
    COINBASE_CUSTODY_1, OPERATIONAL_1, COINBASE_CUSTODY_2, FOUNDERS_TRADING, STAKING_REWARDS_1,
    STAKING_REWARDS_2, COINBASE_CUSTODY_3, PRIVATE_SALE_REMAINING, ETH_LIQUIDITY, COINBASE_CUSTODY_4, 
...
export async function getPoSStatus(model: Model, resources: OrbsEthResrouces, web3: any) {
    ...
    const unlockedNonCirculating = await sumUnlocked(NON_CIRCULATING_WALLETS_CMC, resources);
